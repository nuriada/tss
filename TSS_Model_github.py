...
# unmet heat as difference of heat demand and potential heat production
data['unmetDHW']=data['DHW']-data['potDHW']
# Excess DHW as difference of potential DHW production and DHW demand -> Might be stored for later heat consumption
data['excessDHW']=(-1.0)*data['unmetDHW']
data.loc[data['excessDHW']<0,'excessDHW']=0
...
data['unmetSH']=data['SH']-data['excessSH']
# Compute excessHeat and unmetHeat considering (excessDHW and excessSH) and (unmetDHW and unmetSH), respectively
data['excessHeat']=-data['unmetSH']
data['unmetHeat']=data['unmetSH']
